<!-- home_轮播 -->
<template>
  <!-- <div :class="slidersData.length==1?'smallBanner':'smallBannerTwo'" v-if="slidersData.length!==0">
      <swiper :class="slidersData.length==1?'smallbanner_list swiper-no-swiping':'smallbanner_listTwo swiper-no-swiping'" v-if="slidersData.length>=1"  :options="swiperOption"> -->
            <!-- slides -->
