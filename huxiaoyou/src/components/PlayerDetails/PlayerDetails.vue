     ...
     <div class="player_des">
      ...
      <div class="vote"  @click.stop>
          ...
          <div class="FreeTicket">
              <span class="FreeTicket_title">免费票</span>
              <span class="FreeTicket_text">免费票每日每人只可投10次</span>
              <span class="FreeTicket_btn" @click.stop="freeticket">剩余{{personData.user_votes}}次</span>
          </div>
          <div class="AssistTicket">
                ...
                <div class="AssistTicket_btn" @click.stop="AssistTicket">助力投票</div>
          </div>
      </div>
      </div>
      <!-- 提示盒子 -->
...
//   components: {},
   ...
   computed:{
            ...mapState(['staticImgH','playerId','addressIdIsSel','addressId','PlayerDetailPage','playDetailVoteDiv','tokenH','playDetailShopDES','apiH'])
        },
  ...
  mounted(){
    ...
    if(this.playDetailVoteDiv=='true'){   //  playDetailVoteDiv 是判断投票盒子是否显示
        ...
        if(this.addressIdIsSel=='true'){   //addressIdIsSel   是判断地址是否选中 或者 没有地址是否添加上地址了 ture为有地址可以走支付 
            ...
            this.playerId=this.playDetailShopDES.playerId   
  ...
  methods: {
    ...
    ...mapMutations(['playDetailVoteDivs','ReceiptAddressPages','ReceiptAddressAddPages','orderTypes','orderNums','playDetailShopDESs','addressIdIsSels','myOrderListPages','playerIds']),
  }
}
