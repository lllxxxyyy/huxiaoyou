...
computed:{
    ...mapState(['staticImgH','ReceiptAddressAddPage','tokenH'])
},
  ...
  methods: {
    ...
    //   设置默认地址
      ...
      returnHome(){ 
          ...
          this.$router.push(this.ReceiptAddressAddPage)
      },
      ...mapMutations(['addressIds','addressIdIsSels']),
  }
}
</script>
