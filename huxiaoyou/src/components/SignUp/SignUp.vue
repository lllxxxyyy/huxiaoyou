      ...
      <div >
            ...
            <div class="remind">
              ...
              <div class="remind_des">
                   1.每日通过微信和直播等分享“<span>赛事投票助力卡包</span>”并被购买成功，立得所分享卡包金额10倍的投票数，同时赢得所分享卡包金额30%的现金奖励。加入“歌游天使直播公会”，分享卡包成功后现金奖励立升至40%！
              </div>
              <div class="remind_des">
                   2.上传图片、视频，必须严格遵守国家法律法规，杜绝反动政治倾向及色情内容。选手所上传内容自行负责法律责任。以上违规一经发现主办方将给予删除和警告，直至取消比赛资格。
              </div>
